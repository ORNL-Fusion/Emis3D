...
configFileName = (
    "NIMROD_config.yaml" #"elongatedRing_config.yaml"  # helical_config.yaml, or elongatedRing_config.yaml
)
#rzvalues = [1.85, 0.0]
...
for time in np.arange(60, 2880, 60):
    ...
    nimrodFile= join(EMIS3D_INPUTS_DIRECTORY,tokamakName,"radDists","NIMROD_data","Nonresonant",f"nimrod_Nonresonant_{timestep}.txt")
